  ...
  return (
    ...
    >
      <div>
        ...
        <select type="text" id="user_id" name="user_id" className="select disabled" >
          <option key={GetUserSession().id} value={GetUserSession().id}>
            {`${GetUserSession().id} - ${GetUserSession().name}`}
          </option>
        </select>
      </div>
      <div>
