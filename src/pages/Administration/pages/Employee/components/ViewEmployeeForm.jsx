...
const ViewEmployeeForm = ({ roles, selectedElement, toggleModalState }) => {
  return (
    <form
    ...
    >
      ...
      <div>
        ...
        >
          <option>
            {roles.find(el => el.id === selectedElement?.user?.role_id)?.name}
          </option>
        </select>
      </div>
      <div>
        ...
        >
          <option>
            {selectedElement?.user?.state ? 'Activo' : 'Inactivo'}
          </option>
        </select>
      </div>
      <div>
